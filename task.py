...
if 'python_assignment_zaiba_khan' in database_name:
    print(' ')
else:
    print('Database not exist, please read the instructions given !')
    sys.exit()
...
print("Extrected ideal function Data :")
print("S.No________x____________________y________________chosen_val")
...
print()
print("Mappings Function :")
print()
print("_x____|___y____|____fit func [A]__|___fit func [B]___|___Deviation")
